...
if __name__ == "__main__":
    ...
    polo_train = generate_data(mu=29, sigma=6, n = 30, label=0)
    golf_train = generate_data(mu=44, sigma=4,n = 30, label=1)

    # Generating data for testing
    polo_test = generate_data(mu=29, sigma=6, n=70, label=0)
    golf_test = generate_data(mu=44, sigma=4, n=70, label=1)
